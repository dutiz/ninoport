...
/**
 * Item in *Project → Slider*
 */
export interface ProjectDocumentDataSliderItem {
  /**
   * sliderImg field in *Project → Slider*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: project.slider[].sliderimg
   * - **Documentation**: https://prismic.io/docs/field#image
   */
...
interface ProjectDocumentData {
  ...
  /**
   * Slider field in *Project*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: project.slider[]
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  slider: prismic.GroupField<Simplify<ProjectDocumentDataSliderItem>> /**
